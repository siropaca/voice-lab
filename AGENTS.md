...
- [docs/google-cloud-setup.md](docs/google-cloud-setup.md) — Google Cloud の API 有効化・IAM ロール・認証（つまずきポイント）
- [docs/notes.md](docs/notes.md) — モデル / プロバイダー固有の挙動・ラボ設計上の注意点
- [docs/specs/index.md](docs/specs/index.md) — 設計・計画ドキュメント（spec）の一覧
